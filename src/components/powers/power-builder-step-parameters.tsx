          ...
          <div className="flex flex-wrap gap-2">
            {(Object.keys(ACTION_LABELS) as ActionType[]).map(action => (
              <ParameterButton
                ...
                onClick={() => onActionChange(action === defaultAction ? null : action)}
          ...
          <div className="flex flex-wrap gap-2">
            {(Object.keys(RANGE_LABELS) as RangeType[]).map(range => (
              <ParameterButton
                ...
                onClick={() => onRangeChange(range === defaultRange ? null : range)}
          ...
          <div className="flex flex-wrap gap-2">
            {(Object.keys(DURATION_LABELS) as DurationType[]).map(duration => (
              <ParameterButton
                ...
                onClick={() => onDurationChange(duration === defaultDuration ? null : duration)}
