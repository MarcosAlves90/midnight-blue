              ...
              <DropdownMenu modal={false}>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="secondary"
                    size="icon"
                    className="h-8 w-8 rounded-full shadow-md bg-background/80 backdrop-blur-sm border border-border"
                  >
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem
                    onClick={() => onMoveToFolder(character.id, null)}
                  >
                    <ChevronRight
                      className={cn(
                        "w-4 h-4 mr-2",
                        !character.folderId && "text-primary",
                      )}
                    />
                    Sem Pasta
                  </DropdownMenuItem>
                  ...
                  {allFolders.map((f) => (
                    ...
                    >
                      <Folder
                        className={cn(
                          "w-4 h-4 mr-2",
                          character.folderId === f.id && "text-primary",
                        )}
                      />
                      {f.name}
                    </DropdownMenuItem>
