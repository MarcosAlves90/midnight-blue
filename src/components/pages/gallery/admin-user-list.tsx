...
export const AdminUserList = React.memo(function AdminUserList({
  ...
  const handleDelete = async (e: React.MouseEvent, user: UserProfile) => {
    ...
    if (
      !confirm(
        `Tem certeza que deseja excluir permanentemente a conta de ${user.displayName || user.email}? Esta ação não pode ser desfeita.`,
      )
    ) {
      return;
    }
          ...
          {users.map((u) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <Check className="w-4 h-4 ml-1 animate-in zoom-in duration-300" />
                )}
              </button>
            );
          })}
        ...
        return (
          <div
            ...
            className={cn(
              ...
              u.isAdmin &&
                "border-yellow-600/40 shadow-[0_0_15px_rgba(234,179,8,0.1)]",
                  ...
                  isSelected
                    ...
                    : u.isAdmin
                      ...
                      : u.disabled
                        ...
                        : "bg-primary/5 border-primary/20 group-hover:border-primary/50",
                )}
              >
              ...
              <div className="flex flex-col items-end gap-1">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48">
                    ...
                    <DropdownMenuItem
                      onClick={(e) =>
                        handleToggleAdmin(e as unknown as React.MouseEvent, u)
                      }
                    >
                      {u.isAdmin ? (
                    ...
                    <DropdownMenuItem
                      onClick={(e) =>
                        handleToggleFreeze(e as unknown as React.MouseEvent, u)
                      }
                    >
                    ...
                    <DropdownMenuItem
                      onClick={(e) =>
                        handleDelete(e as unknown as React.MouseEvent, u)
                      }
