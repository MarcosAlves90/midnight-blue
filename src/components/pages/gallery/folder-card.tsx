...
import { Folder, MoreVertical, Trash2, ChevronRight } from "lucide-react";
...
import type { Folder as FolderType } from "@/lib/character-service";
...
export function FolderCard({ folder, onClick, onDelete }: FolderCardProps) {
  return (
    ...
    >
      ...
      <Folder className="absolute -right-4 -bottom-4 w-24 h-24 text-primary/5 -rotate-12 group-hover:text-primary/10 transition-colors" />
      ...
      <div className="flex items-center justify-between mt-auto pt-2 border-t border-border/50 relative z-10">
        <span className="text-[9px] font-mono text-muted-foreground uppercase">Acessar Arquivos</span>
