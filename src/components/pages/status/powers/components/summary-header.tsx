...
export const PowerSummaryHeader = memo(
  ({ name, onNameChange, totalCost, rank }: PowerSummaryHeaderProps) => {
    return (
      <div className="flex flex-col gap-4 border-b border-white/5 p-2 sm:max-h-16">
        <div className="flex max-sm:flex-col items-start justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 max-sm:w-full">
            <div className="px-2 sm:px-4 py-1 bg-black/40 border border-white/10 flex max-sm:justify-between items-center sm:flex-col sm:items-end max-sm:w-full">
              <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-tighter">
                Custo Total
              </span>
              <div className="flex items-center gap-1.5">
                <span className="text-xl sm:text-2xl font-black text-blue-400 leading-none">
                  {totalCost}
                </span>
            ...
            <Tip content="Custo base baseado na maior graduação entre os efeitos.">
              <div className="px-2 sm:px-4 py-1 bg-blue-500/10 border border-blue-500/20 flex max-sm:justify-between items-center sm:flex-col sm:items-end cursor-help max-sm:w-full">
