 ...
 */
export const IdentityCardContent: React.FC<IdentityCardContentProps> = React.memo(({
  favoriteColor,
}) => {
  ...
  const onUpdateName = useCallback((v: string) => {
    ...
    >
      ...
      >
        <div className="flex items-center justify-between opacity-80">
          <div style={subjectLabelStyle} className="text-[9px] tracking-widest uppercase font-bold">
            <GlitchText
              glitchChance={0.15}
              glitchDuration={120}
              intervalMs={200}
