...
const COMPLICATION_PLACEHOLDERS: Record<string, string> = {
  "Motivação: Aceitação":
    "Por que o herói busca aceitação? Ele se sente diferente ou isolado?",
  "Motivação: Adrenalina":
    "Como a busca por emoção e perigo afeta as decisões do herói?",
  "Motivação: Cobiça":
    "O que o herói busca ganhar? Dinheiro, fama ou recursos?",
  "Motivação: Fazer o Bem":
    "O que impulsiona o senso moral do herói? Alguma promessa ou crença?",
  "Motivação: Justiça":
    "Até onde o herói vai para punir os culpados? Ele opera fora da lei?",
  "Motivação: Patriotismo":
    "A qual nação ou ideal o herói é devoto? Isso entra em conflito com outros deveres?",
  "Motivação: Reconhecimento":
    "Por que o herói precisa ser notado? Ele teme o esquecimento?",
  "Motivação: Responsabilidade":
    "Qual é o dever que o herói sente que deve cumprir?",
  ...
  Identidade:
    "Quem é o herói na vida civil e por que isso deve ser mantido em segredo?",
  ...
  "Perda de Poder":
    "O que faz os poderes do herói falharem? (Ex: Falta de sol, objeto roubado)",
  Preconceito:
    "Por que o herói sofre preconceito? Aparência, origem ou crença?",
  Relacionamento:
    "Quem são as pessoas importantes que podem ser usadas contra o herói?",
  Reputação: "Por que as pessoas desconfiam ou temem o herói?",
  Responsabilidade:
    "Quais obrigações (trabalho, família) conflitam com a vida de herói?",
...
export const ComplicationsSectionInner: React.FC = () => {
  ...
  return (
    <div className="bg-muted/50 rounded-none p-4 border border-white/5">
        ...
        <Tip
          content={
            <div className="max-w-xs text-xs space-y-2">
              <p>
                As Complicações representam desafios, problemas pessoais ou
                vulnerabilidades que os heróis devem superar.
              </p>
              <p>
                Quando uma Complicação afeta o herói no jogo, o jogador recebe{" "}
                <strong>Pontos Heróicos</strong>.
              </p>
              <p>
                Você deve escolher pelo menos duas Complicações, sendo uma delas
                a <strong>Motivação</strong>.
              </p>
            </div>
          }
          side="top"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-8">
            ...
            <FormInput
              ...
              placeholder={
                COMPLICATION_PLACEHOLDERS[selectedType] ||
                "Descreva a complicação..."
              }
