  ...
  return (
    <Card className="overflow-hidden relative group bg-muted/20 backdrop-blur-sm border-primary/10 hover:border-primary/30 transition-all duration-300">
      ...
      <CardContent>
        <div
          className={cn(
            "text-xl font-black tracking-tighter italic uppercase text-foreground/90 group-hover:text-primary transition-colors",
            valueClassName,
          )}
        >
          {value === null ? (
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          <p className="text-[9px] text-muted-foreground/60 uppercase font-mono tracking-tight">
            {description}
          </p>
        </div>
      </CardContent>
