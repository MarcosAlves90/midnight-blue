...
export class CharacterStorageService {
  ...
  static getStoredOwnerId = () =>
    typeof window !== "undefined"
      ? localStorage.getItem(KEYS.CURRENT_OWNER)
      : null;

  static getStoredLastOwnId = () =>
    typeof window !== "undefined"
      ? localStorage.getItem(KEYS.LAST_OWN_ID)
      : null;

  static getStoredCurrentId = () =>
    typeof window !== "undefined"
      ? localStorage.getItem(KEYS.CURRENT_ID)
      : null;
}
