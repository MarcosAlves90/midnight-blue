...
const LOCATIONS: GrammaticalItem[] = [
  ...
  {
    text: "Subterrâneos de Sevastópol",
    gender: "M",
    number: "P",
    hasArticle: true,
    tags: ["underground"],
  ...
  {
    text: "Setor de Contenção S",
    gender: "M",
    number: "S",
    hasArticle: true,
    tags: ["prison", "dangerous"],
  },
  {
    text: "Colônia Lunar Alpha",
    gender: "F",
    number: "S",
    hasArticle: true,
    tags: ["space", "colony"],
  ...
  {
    text: "Plataforma Marítima Delta",
    gender: "F",
    number: "S",
    hasArticle: true,
    tags: ["ocean"],
  ...
  {
    text: "Deserto de Sal de Atacama",
    gender: "M",
    number: "S",
    hasArticle: true,
    tags: ["wasteland"],
  ...
  {
    text: "Cidade Flutuante de Aether",
    gender: "F",
    number: "S",
    hasArticle: true,
    tags: ["sky", "elite"],
...
const ENTITIES: GrammaticalItem[] = [
  ...
  {
    text: "Unidade de Resposta Rápida",
    gender: "F",
    number: "S",
    tags: ["military"],
  },
  ...
  {
    text: "Senhores do Aço",
    gender: "M",
    number: "P",
    tags: ["mercenary", "combat"],
  },
  {
    text: "Coligação Mellífera",
    gender: "F",
    number: "S",
    tags: ["corp", "trade"],
  },
...
const ACTIONS: ActionItem[] = [
  ...
  {
    singular: "interceptou",
    plural: "interceptaram",
    tense: "past",
    intensity: 3,
  },
  {
    singular: "iniciou testes",
    plural: "iniciaram testes",
    tense: "present",
    intensity: 1,
  },
  {
    singular: "ativou protocolo",
    plural: "ativaram protocolo",
    tense: "past",
    intensity: 4,
  },
  {
  ...
  {
    singular: "neutralizou",
    plural: "neutralizaram",
    tense: "past",
    intensity: 5,
  },
  ...
  {
    singular: "reivindicou",
    plural: "reivindicaram",
    tense: "past",
    intensity: 3,
  },
  ...
  {
    singular: "sincronizou",
    plural: "sincronizaram",
    tense: "past",
    intensity: 2,
  },
  { singular: "deletou", plural: "deletaram", tense: "past", intensity: 4 },
  {
    singular: "reconfigurou",
    plural: "reconfiguraram",
    tense: "past",
    intensity: 3,
  },
  ...
  {
    singular: "lavou dinheiro de",
    plural: "lavaram dinheiro de",
    tense: "past",
    intensity: 4,
  },
  {
    singular: "expandiu influência em",
    plural: "expandiram influência em",
    tense: "past",
    intensity: 3,
  },
  {
    singular: "desestabilizou",
    plural: "desestabilizaram",
    tense: "past",
    intensity: 5,
  },
  ...
  {
    singular: "está monitorando",
    plural: "estão monitorando",
    tense: "present",
    intensity: 1,
  },
];
...
class NewsGeneratorEngine {
  ...
  public generate(seed?: number): NewsItem {
    ...
    else if (typeRoll > 0.8) type = "alert";
    else if (typeRoll > 0.5) type = "warning";
